  ...
  const supplements = await Promise.all([
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 9.99,
        amazonUrl: "https://www.amazon.com/dp/B000FGXMX2",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 26.00,
        amazonUrl: "https://www.amazon.com/dp/B0013OULVA",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 42.95,
        amazonUrl: "https://www.amazon.com/dp/B002CQU54Y",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 27.97,
        amazonUrl: "https://www.amazon.com/dp/B07MGKBB6P",
    ...
    prisma.product.create({
      data: {
        name: "Vital Proteins Collagen Peptides Powder 14.3oz",
        brand: "Vital Proteins",
        imageUrl: null,
        price: 29.00,
        amazonUrl: "https://www.amazon.com/dp/B00K6KAM7A",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 15.99,
        amazonUrl: "https://www.amazon.com/dp/B00GB85JR4",
    ...
    prisma.product.create({
      data: {
        name: "Nature Made Super B-Complex 140 tablets",
        brand: "Nature Made",
        imageUrl: null,
        price: 11.99,
        amazonUrl: "https://www.amazon.com/dp/B000GG87UO",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 10.99,
        amazonUrl: "https://www.amazon.com/dp/B000MGOXEC",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 19.99,
        amazonUrl: "https://www.amazon.com/dp/B08CK4LRSB",
  ...
  const skincare = await Promise.all([
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 37.99,
        amazonUrl: "https://www.amazon.com/dp/B079MZQ97C",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 19.99,
        amazonUrl: "https://www.amazon.com/dp/B01N7T7JKJ",
    ...
    prisma.product.create({
      data: {
        name: "Neutrogena Rapid Wrinkle Repair Retinol Serum 1oz",
        brand: "Neutrogena",
        imageUrl: null,
        price: 21.97,
        amazonUrl: "https://www.amazon.com/dp/B00BVBR27Y",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 39.00,
        amazonUrl: "https://www.amazon.com/dp/B002MSN3QQ",
  ...
  const dental = await Promise.all([
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 49.99,
        amazonUrl: "https://www.amazon.com/dp/B00AOHXKM4",
    ...
    prisma.product.create({
      data: {
        name: "Crest Pro-Health Gum Detoxify Toothpaste 4.8oz (2-pack)",
        brand: "Crest",
        imageUrl: null,
        price: 11.97,
        amazonUrl: "https://www.amazon.com/dp/B07C53D4NQ",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 9.97,
        amazonUrl: "https://www.amazon.com/dp/B001ETQ8GC",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 49.95,
        amazonUrl: "https://www.amazon.com/dp/B078GVDB19",
  ...
  const devices = await Promise.all([
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 49.99,
        amazonUrl: "https://www.amazon.com/dp/B01N8UULZD",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 39.99,
        amazonUrl: "https://www.amazon.com/dp/B00R5XQO5U",
    ...
    prisma.product.create({
      data: {
        ...
        imageUrl: null,
        price: 19.99,
        amazonUrl: "https://www.amazon.com/dp/B00P4XQRPU",
  ...
  const wearables = await Promise.all([
    prisma.product.create({
      data: {
        ...
        affiliateUrl: "https://www.amazon.com/dp/B0DGHQWFNL",
